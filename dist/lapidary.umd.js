(function (global, factory) {
  ...
  var dateFns_72 = dateFns.isEqual;
  ...
  var DateEqualityEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          var objectKey = l.getFacet(facetKey).objectKey;
          return dateFns_72(dateFns_118(item[objectKey]), dateFns_118(cleanString(expression, facetKey)));
      };
  };
  ...
  var DateLTEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          var objectKey = l.getFacet(facetKey).objectKey;
          return dateFns_70(dateFns_118(item[objectKey]), dateFns_118(cleanString(expression, facetKey)));
      };
  };
  var DateLTEEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          var objectKey = l.getFacet(facetKey).objectKey;
          var date1 = dateFns_118(item[objectKey]);
          var date2 = dateFns_118(cleanString(expression, facetKey));
          return dateFns_70(date1, date2) || dateFns_72(date1, date2);
      };
  };
  var DateGTEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          var objectKey = l.getFacet(facetKey).objectKey;
          return dateFns_69(dateFns_118(item[objectKey]), dateFns_118(cleanString(expression, facetKey)));
      };
  };
  var DateGTEEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          ...
          var date1 = dateFns_118(item[objectKey]);
          var date2 = dateFns_118(cleanString(expression, facetKey));
          return dateFns_69(date1, date2) || dateFns_72(date1, date2);
      };
  };
  var DateBetweenEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          var objectKey = l.getFacet(facetKey).objectKey;
          var _a = expression.split(','), lower = _a[0], upper = _a[1];
          var date = dateFns_118(item[objectKey]);
          var lowerDate = dateFns_118(cleanString(lower, facetKey));
          var upperDate = dateFns_118(cleanString(upper, facetKey));
          return dateFns_69(date, lowerDate) && dateFns_70(date, upperDate);
      };
  };
  var DateInclusiveBetweenEvaluationGenerator = function (facetKey, expression) {
      return function (item, l) {
          ...
          var upperDate = dateFns_118(cleanString(upper, facetKey));
          return ((dateFns_69(date, lowerDate) && dateFns_70(date, upperDate)) ||
              dateFns_72(date, lowerDate) ||
              dateFns_72(date, upperDate));
      };
  };
  ...
  var DateOperations = (_c = {},
      _c[EQUAL] = DateEqualityEvaluationGenerator,
      _c[NOT_EQUAL] = DateNegativeEqualityEvaluationGenerator,
      _c[GREATER_THAN] = DateGTEvaluationGenerator,
      _c[LESS_THAN] = DateLTEvaluationGenerator,
      _c[GREATER_THAN_OR_EQUAL] = DateGTEEvaluationGenerator,
      _c[LESS_THAN_OR_EQUAL] = DateLTEEvaluationGenerator,
...
//# sourceMappingURL=lapidary.umd.js.map
